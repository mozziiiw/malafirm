    ...
    return (
        <section className="overflow-hidden py-32">
            <div className="mx-auto max-w-5xl space-y-16 px-6">
                <h2 className="text-title relative z-10 max-w-xl text-4xl font-medium lg:text-5xl">Brief Legal Advice on Australia Immigration Laws</h2>
                <div className="grid gap-6 sm:grid-cols-2 md:gap-12 lg:gap-24">
                    ...
                    <div className="relative space-y-4">
                        <p className="text-body">Australia has the third highest number of international students in the world with strong track record, quality research institutions and commitment to world-class innovation. Australia has talented and highly skilled workforce for investors to realise their potential.</p>
                        {/* <div className="pt-6">
