    ...
    return (
        <section className="overflow-hidden py-32">
            <div className="mx-auto max-w-5xl space-y-16 px-6">
                <h2 className="text-title relative z-10 max-w-xl text-4xl font-medium lg:text-5xl">Brief Legal Advice on UAE Immigration Laws</h2>
                <div className="grid gap-6 sm:grid-cols-2 md:gap-12 lg:gap-24">
                    ...
                    <div className="relative space-y-4">
                        <p className="text-body">“UAE Immigration Laws” Citizens can freely travel, work, retire, or just vacate without any problems in any UAE Country. The advantages of citizenship in an UAE country is that the UAE Immigration laws and regulations of the UAE apply to any country that you decide to live and work in.</p>
                        {/* <div className="pt-6">
